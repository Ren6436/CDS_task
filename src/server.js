...
app.put('/match/:id', async (req, res) => {
    ...
    const result = await client.query(
        `UPDATE match SET home_team_id = $1, guest_team_id = $2, date = $3 WHERE id = $4 RETURNING *`,
        [home_team_id, guest_team_id, date, id]
    );
...
app.put('/event/:id', async (req, res) => {
    ...
    const result = await client.query(
        ...
        [match_id, team_id, type, minutes, id]
    );
